...
class CountersControllerTest < ActionController::TestCase
  ...
  test "should create counter" do
    assert_difference('Counter.count') do
      post :create, counter: { currency: @counter.currency, fullname: @counter.fullname, listedBoard: @counter.listedBoard, sgxcode: @counter.sgxcode }
    end
  ...
  test "should update counter" do
    patch :update, id: @counter, counter: { currency: @counter.currency, fullname: @counter.fullname, listedBoard: @counter.listedBoard, sgxcode: @counter.sgxcode }
    assert_redirected_to counter_path(assigns(:counter))
  end
